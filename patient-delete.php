...
<head>
  ...
  <title>PATIENTS DELETE SECTION</title>
</head>
<body>
  <div class="card">
    ...
    <a href="payment.php" class="list-group-item">Payment/Checkout</a>
      <a href="doctor.php" class="list-group-item">Doctors Section</a>
        <a href="docdeletephp.php" class="list-group-item">Doctors Delete Section</a>
         <a href="" class="list-group-item">Patient Delete Section</a>
...
<div class="card">
          <div class="card-body">
        <form class="form-group" method="post" action="111.php">
          ...
          <input type="submit" name="p_sub" value="Delete Patient" class="btn btn-primary">
        </form>
      </div>
    </div><br><br>
   </div>
